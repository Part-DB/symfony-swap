            ...
            ->children()
                ...
                ->arrayNode('providers')
                    ->children()
                        ...
                        ->append($this->createSimpleProviderNode('frankfurter'))
                        ->append($this->createSimpleProviderNode('fawazahmed_currency_api'))
                        ->append($this->createSimpleProviderNode('bulgarian_national_bank'))
                        ->append($this->createSimpleProviderNode('national_bank_of_ukraine'))
